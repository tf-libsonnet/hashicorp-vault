---
permalink: /data/aws_static_access_credentials/
---

# data.aws_static_access_credentials

`aws_static_access_credentials` represents the `vault_aws_static_access_credentials` Terraform data source.
