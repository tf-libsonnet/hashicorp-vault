---
permalink: /data/pki_secret_backend_keys/
---

# data.pki_secret_backend_keys

`pki_secret_backend_keys` represents the `vault_pki_secret_backend_keys` Terraform data source.
