---
permalink: /data/pki_secret_backend_issuers/
---

# data.pki_secret_backend_issuers

`pki_secret_backend_issuers` represents the `vault_pki_secret_backend_issuers` Terraform data source.
