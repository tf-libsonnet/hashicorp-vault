...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withPermanentlyDelete':: d.fn(help='`vault.bool.withPermanentlyDelete` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the permanently_delete field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `permanently_delete` field.\n', args=[]),
  withPermanentlyDelete(resourceLabel, value): {
    resource+: {
      vault_azure_secret_backend_role+: {
        [resourceLabel]+: {
          permanently_delete: value,
        },
      },
    },
  },
  ...
  '#withTags':: d.fn(help='`vault.list.withTags` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the tags field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `tags` field.\n', args=[]),
