...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withCredentialConfig':: d.fn(help='`vault.obj.withCredentialConfig` constructs a mixin object that can be merged into the `obj`\nTerraform resource block to set or update the credential_config field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`obj`): The value to set for the `credential_config` field.\n', args=[]),
  withCredentialConfig(resourceLabel, value): {
    resource+: {
      vault_database_secret_backend_role+: {
        [resourceLabel]+: {
