...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  new(
    ...
    sts_endpoint=null,
    sts_region=null,
    use_sts_region_from_client=null,
    _meta={}
  ):: tf.withResource(
  ...
  '#withUseStsRegionFromClient':: d.fn(help='`vault.bool.withUseStsRegionFromClient` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the use_sts_region_from_client field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `use_sts_region_from_client` field.\n', args=[]),
  withUseStsRegionFromClient(resourceLabel, value): {
    resource+: {
      vault_aws_auth_backend_client+: {
        [resourceLabel]+: {
          use_sts_region_from_client: value,
        },
      },
    },
  },
