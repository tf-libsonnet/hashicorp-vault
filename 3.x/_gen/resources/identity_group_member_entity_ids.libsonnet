...
{
  '#':: d.pkg(name='identity_group_member_entity_ids', url='', help='`identity_group_member_entity_ids` represents the `vault_identity_group_member_entity_ids` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
