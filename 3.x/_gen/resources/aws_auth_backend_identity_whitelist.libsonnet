...
{
  '#':: d.pkg(name='aws_auth_backend_identity_whitelist', url='', help='`aws_auth_backend_identity_whitelist` represents the `vault_aws_auth_backend_identity_whitelist` Terraform resource.\n\n\n\nThis package contains functions and utilities for setting up the resource using Jsonnet code.\n'),
