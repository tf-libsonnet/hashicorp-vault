...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withAllowedUserIds':: d.fn(help='`vault.list.withAllowedUserIds` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the allowed_user_ids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `allowed_user_ids` field.\n', args=[]),
  withAllowedUserIds(resourceLabel, value): {
    resource+: {
      vault_pki_secret_backend_role+: {
        [resourceLabel]+: {
  ...
  '#withExtKeyUsageOids':: d.fn(help='`vault.list.withExtKeyUsageOids` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the ext_key_usage_oids field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `ext_key_usage_oids` field.\n', args=[]),
  withExtKeyUsageOids(resourceLabel, value): {
    resource+: {
      vault_pki_secret_backend_role+: {
        [resourceLabel]+: {
          ext_key_usage_oids: value,
        },
      },
    },
  },
