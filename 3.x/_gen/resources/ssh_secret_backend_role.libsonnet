...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withDefaultUserTemplate':: d.fn(help='`vault.bool.withDefaultUserTemplate` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the default_user_template field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `default_user_template` field.\n', args=[]),
  withDefaultUserTemplate(resourceLabel, value): {
    resource+: {
      vault_ssh_secret_backend_role+: {
        [resourceLabel]+: {
          default_user_template: value,
        },
      },
    },
  },
