...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withOcspCaCertificates':: d.fn(help='`vault.string.withOcspCaCertificates` constructs a mixin object that can be merged into the `string`\nTerraform resource block to set or update the ocsp_ca_certificates field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`string`): The value to set for the `ocsp_ca_certificates` field.\n', args=[]),
  withOcspCaCertificates(resourceLabel, value): {
    resource+: {
      vault_cert_auth_backend_role+: {
        [resourceLabel]+: {
          ocsp_ca_certificates: value,
        },
      },
    },
  },
  '#withOcspEnabled':: d.fn(help='`vault.bool.withOcspEnabled` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the ocsp_enabled field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `ocsp_enabled` field.\n', args=[]),
  withOcspEnabled(resourceLabel, value): {
    resource+: {
      vault_cert_auth_backend_role+: {
        [resourceLabel]+: {
          ocsp_enabled: value,
  ...
  '#withOcspFailOpen':: d.fn(help='`vault.bool.withOcspFailOpen` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the ocsp_fail_open field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `ocsp_fail_open` field.\n', args=[]),
  withOcspFailOpen(resourceLabel, value): {
    resource+: {
      vault_cert_auth_backend_role+: {
        [resourceLabel]+: {
          ocsp_fail_open: value,
        },
      },
    },
  },
  '#withOcspQueryAllServers':: d.fn(help='`vault.bool.withOcspQueryAllServers` constructs a mixin object that can be merged into the `bool`\nTerraform resource block to set or update the ocsp_query_all_servers field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`bool`): The value to set for the `ocsp_query_all_servers` field.\n', args=[]),
  withOcspQueryAllServers(resourceLabel, value): {
    resource+: {
      vault_cert_auth_backend_role+: {
        [resourceLabel]+: {
          ocsp_query_all_servers: value,
        },
      },
    },
  },
  '#withOcspServersOverride':: d.fn(help='`vault.list.withOcspServersOverride` constructs a mixin object that can be merged into the `list`\nTerraform resource block to set or update the ocsp_servers_override field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`list`): The value to set for the `ocsp_servers_override` field.\n', args=[]),
  withOcspServersOverride(resourceLabel, value): {
    resource+: {
      vault_cert_auth_backend_role+: {
        [resourceLabel]+: {
          ocsp_servers_override: value,
        },
      },
    },
  },
