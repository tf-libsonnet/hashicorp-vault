...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withMaxPageSize':: d.fn(help='`vault.number.withMaxPageSize` constructs a mixin object that can be merged into the `number`\nTerraform resource block to set or update the max_page_size field.\n\n\n\n**Args**:\n  - `resourceLabel` (`string`): The name label of the block to update.\n  - `value` (`number`): The value to set for the `max_page_size` field.\n', args=[]),
  withMaxPageSize(resourceLabel, value): {
    resource+: {
      vault_ldap_auth_backend+: {
        [resourceLabel]+: {
          max_page_size: value,
