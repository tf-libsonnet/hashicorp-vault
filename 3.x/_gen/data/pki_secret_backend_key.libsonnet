...
{
  '#':: d.pkg(name='pki_secret_backend_key', url='', help='`pki_secret_backend_key` represents the `vault_pki_secret_backend_key` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(backend=backend, key_ref=key_ref, namespace=namespace),
    _meta=_meta
  ),
