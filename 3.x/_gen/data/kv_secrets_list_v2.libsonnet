...
{
  '#':: d.pkg(name='kv_secrets_list_v2', url='', help='`kv_secrets_list_v2` represents the `vault_kv_secrets_list_v2` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(mount=mount, name=name, namespace=namespace),
    _meta=_meta
  ),
