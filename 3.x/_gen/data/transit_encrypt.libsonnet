...
{
  '#':: d.pkg(name='transit_encrypt', url='', help='`transit_encrypt` represents the `vault_transit_encrypt` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  '#withKeyVersion':: d.fn(help='`vault.number.withKeyVersion` constructs a mixin object that can be merged into the `number`\nTerraform data source block to set or update the key_version field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`number`): The value to set for the `key_version` field.\n', args=[]),
  withKeyVersion(dataSrcLabel, value): {
    data+: {
      vault_transit_encrypt+: {
        [dataSrcLabel]+: {
          key_version: value,
