...
{
  '#':: d.pkg(name='approle_auth_backend_role_id', url='', help='`approle_auth_backend_role_id` represents the `vault_approle_auth_backend_role_id` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(backend=backend, namespace=namespace, role_name=role_name),
    _meta=_meta
  ),
