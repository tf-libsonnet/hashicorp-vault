...
{
  '#':: d.pkg(name='identity_oidc_openid_config', url='', help='`identity_oidc_openid_config` represents the `vault_identity_oidc_openid_config` Terraform data source.\n\n\n\nThis package contains functions and utilities for setting up the data source using Jsonnet code.\n'),
  ...
  new(
    ...
    label=dataSrcLabel,
    attrs=self.newAttrs(name=name, namespace=namespace),
    _meta=_meta
  ),
